...
double responsiveSize(
  ...
  double responsiveWidth = width >= 1200
      ? (xl ?? lg)
      : width >= 992
          ? (lg)
          : width >= 768
...
double responsiveSizeInt(
  ...
  int responsiveWidth = (width >= 1200
      ? (xl ?? lg)
      : width >= 992
          ? (lg)
          : width >= 768
  ...
  return responsiveWidth.toDouble();
}
...
Color responsiveColor(
  ...
  Color responsiveColor = width >= 1200
      ? (xl ?? lg)
      : width >= 992
          ? (lg)
          : width >= 768

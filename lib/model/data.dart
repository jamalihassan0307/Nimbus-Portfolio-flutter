...
class Data {
  ...
  static List<ProjectCategoryData> projectCategories = [
    ...
    ProjectCategoryData(title: StringConst.IOS, number: 1),
    ProjectCategoryData(title: StringConst.APIS1, number: 1),
    ProjectCategoryData(title: StringConst.ChatGpt2345, number: 4),
    ProjectCategoryData(title: StringConst.DotNet, number: 1),
  ];
  ...
  static List<ProjectData> allProjects = [
    ...
    ProjectData(link:StringConst.port2,
      ...
      category: StringConst.Flutter267,  
    ...
    ProjectData(
      ...
      category: StringConst.ChatGpt2345 ,
  ...
  static List<ProjectData> DotNet = [
      ProjectData(
      link:StringConst.port1,
      title: StringConst.PORTFOLIO_1_TITLE,
      category: StringConst.APIS1,
